...
**{{count:figuras;legend=Exemplo do Versionamento Semântico (SemVer)}}**
...
**{{count:figuras;legend=Exemplo de teste utilizando o Jest para javascript e o Pest para PHP}}**
