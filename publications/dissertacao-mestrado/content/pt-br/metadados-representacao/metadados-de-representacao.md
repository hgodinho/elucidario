## 6. Metadados de representação e descrição de itens museológicos
...
### 6.1 - Esquema de metadados para descrição de obras de arte em museus brasileiros: uma proposta. [@silva2020]
